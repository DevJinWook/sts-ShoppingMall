...
<FORM name="goodRetrieveForm" method="GET" action="#">
				...
				<table align="center" width="1000" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td colspan="2"><font color="#2e56a9" size="2"
							style='padding-left: 30px'><b> 무료배송</b> </font> <font size="2">
							(도서  산간지역 별도 배송비 추가)</font></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" style="padding-left: 30px; height: 68px;"><select
					...
					<tr>
						...
						<td style="padding-left: 30px">
						    ...
						    <input type="text" name="gAmount" value="1" id="gAmount" style="text-align: right; height: 18px; vertical-align: middle;">
						
							<img src="images/up.png" id="up" style="vertical-align: middle;"> 
							<img src="images/down.png" id="down" style="vertical-align: middle;">
							</div>
						</td>
					</tr>
				</table>
	...
	<br> 
	<button class="orderBtn" >구매</button>
	&nbsp;&nbsp;
