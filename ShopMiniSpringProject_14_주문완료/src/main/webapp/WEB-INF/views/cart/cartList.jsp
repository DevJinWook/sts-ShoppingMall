...
<table width="90%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td class="td_default" align="center" style="width: 90px">
		<input type="checkbox"
...
<c:forEach var="x" items="${cartList}">
		...
		<tr>
			<td class="td_default" width="90" style="
    text-align: center;">
			...
			<input type="checkbox"
				...
				value="${x.num}"></td>
			<td class="td_default" width="120" style="text-align: center;">${x.num}</td>
			...
			<td style="width: 90px;"><input type="button" value="수정"
			     class="updateBtn"
			     data-num="${x.num}" 
			...
			<td style="width: 90px;"><input type="button" value="주문" class="orderBtn"
				data-num="${x.num}"></td>
 ...
 <!-- 반복끝 --> 
	...
	<tr>
		<td align="center" colspan="4">
			<button id="orderAll">전체 주문하기</button>&nbsp;
			<button id="delAllCart">전체 삭제하기</button>&nbsp;
			<a class="a_black" href="goodsList?gCategory=top" style="color: #2c2c2c; text-decoration: none;"> 계속 쇼핑하기 </a>&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
	<tr>
		<td height="20">
